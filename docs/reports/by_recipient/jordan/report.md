...
- **Jordan balances multiple patrons** — China leads (37%) but engages U.S., Turkey substantially too. **(M)**
- **Division of labor by instrument:** Economic→**China**, Social→**China**, Military→**U.S.**, Diplomacy→**China**. **(H)**
...
Jordan's external-influence field is **balancing (multi-patron)**. The classic division of labor is on display: **China supplies the economics and the U.S. the security** — the Gulf-hedge pattern at the country level.
