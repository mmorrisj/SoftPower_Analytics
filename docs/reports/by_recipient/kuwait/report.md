...
57 peripheral events (where Kuwait was only mentioned in
...
- **Adversarial framing:** 12.5% of the U.S.'s coverage in Kuwait is carried by Iranian media — its image here is partly written by its adversary. **(M)**
